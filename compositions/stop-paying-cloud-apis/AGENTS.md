...
- `index.html` — main composition (landscape 1920x1080)
- `index-portrait.html` — portrait variant (1080x1920)
- `narration.txt` — TTS script
- `narration.wav` — generated audio via Kokoro TTS
